...
with col3:
    st.image("администрация_ч27/зам. начальника ЖБУ.jpg")
with col4:
    st.markdown("""
        <div class="colored-container">
                <div class="highlight-green">
...
with col5:
    st.image("администрация_ч27/зам. начальника ЖБУ 2.jpg")
with col6:
    st.markdown("""
        <div class="colored-container">
                <div class="highlight-green">
...
with col9:
    st.image("администрация_ч27/ннн.jpg")
with col10:
    st.markdown("""
        <div class="colored-container">
                <div class="highlight-blue">
...
with col11:
    st.image("администрация_ч27/делопроизводитель.jpg")
with col12:
    st.markdown("""
        <div class="colored-container">
                <div class="highlight-blue">
...
with col13:
    st.image("администрация_ч27/делопроизводитель 2.jpg")
with col14:
    st.markdown("""
        <div class="colored-container">
                <div class="highlight-blue">
