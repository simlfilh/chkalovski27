...
st.markdown("""
    ...
    <div class="colored-container">
        <p>В общежитии №2 на 1 этаже расположены гостевые блоки.</p>
...
st.markdown("""
    <div class="colored-container">
        ...
        у заведующего общежитием (в его отсутствие - у заместителя заведующего 
        общежитием или коменданта), оплачивает срок проживания, получает пропуск.</p>
